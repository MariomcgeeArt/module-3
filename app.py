...
def compliments_results():
    ...
    selective_compliments = random.sample(compliments, k=int(num_compliments))
    print(selective_compliments)
    ...
    context = {
        ...
        'compliments':  selective_compliments
...
def animal_facts():
    ...
    if user_animal is not None:
        animal_fact = animal_to_fact[user_animal]
...
def image_filter():
    ...
    users_filter = request.args.get('filter')

    if request.method == 'POST':
        users_filter = request.form.get('filter')
